...
predictor = dlib.shape_predictor("C:\\Sk PC\\COLLEGE\\Sem 8\\Minor project\\VisionStay\\shape_predictor_68_face_landmarks.dat")

data_dir = "C:\\Sk PC\\COLLEGE\\Sem 8\\Minor project\\VisionStay\\new_augmented_dataset"
encodings = []
...
print("✅ Embeddings saved to Face embeddings.pkl")
